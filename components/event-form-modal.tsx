...
interface EventFormModalProps {
  ...
  eventToEdit?: any // Event object when editing
  onEventUpdated?: () => void
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700 flex items-center">
                <div className={cn("w-3 h-3 rounded-full mr-2", getEventTypeColor(eventType))}></div>
                Event Type *
              </Label>              <Select
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                id="location"
                {...register("location")}
                placeholder="e.g., Makati City, Project Site"
                className="w-full pl-10"
              />
            </div>
            {errors.location && (
